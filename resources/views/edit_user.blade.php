...
<div class="relative flex justify-center items-center min-h-[80vh] bg-gradient-to-br from-pink-200 via-white to-blue-200 overflow-hidden">
    ...
    <div class="relative w-full max-w-md bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-pink-200/50">
        <h1 class="text-2xl font-bold text-center text-pink-600 mb-6">Edit Pengguna</h1>
        ...
        <form action="{{ route('user.update', $user->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="nama" name="nama"
                       ...
                       required
                       class="mt-1 w-full px-4 py-2 border border-pink-300 rounded-xl 
            ...
            <div>
                ...
                <input type="number" id="NPM" name="NPM"
                       ...
                       required
                       class="mt-1 w-full px-4 py-2 border border-blue-300 rounded-xl 
                ...
                <select name="kelas_id" id="kelas_id"
                    ...
                    @foreach ($kelas as $kelasItem)
                        <option value="{{ $kelasItem->id }}" 
                                @if ($user->kelas_id == $kelasItem->id) selected @endif>
            ...
            <div class="pt-4">
                <button type="submit"
                        class="w-full py-2.5 bg-gradient-to-r from-pink-400 to-blue-400 
                               hover:from-pink-500 hover:to-blue-500 text-white 
